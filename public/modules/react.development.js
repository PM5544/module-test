...
Component$1.prototype.setState = function (partialState, callback) {
  invariant_1(typeof partialState === 'object' || typeof partialState === 'function' || partialState == null, 'setState(...): takes an object of state variables to update or a ' + 'function which returns an object of state variables.');
...
if (__DEV__) {
  ...
  const defineDeprecationWarning = function (methodName, info) {
    Object.defineProperty(Component$1.prototype, methodName, {
      get: function () {
...
const pureComponentPrototype = PureComponent$1.prototype = new ComponentDummy();
pureComponentPrototype.constructor = PureComponent$1;
// Avoid an extra prototype jump for these methods.
Object.assign(pureComponentPrototype, Component$1.prototype);
...
// Avoid an extra prototype jump for these methods.
Object.assign(asyncComponentPrototype, Component$1.prototype);
...
function onlyChild(children) {
  invariant_1(isValidElement$1(children), 'React.Children.only expected to receive a single React element child.');
  return children;
}
...
function createElementWithValidation(type, props, children) {
  ...
  const element = createElement$1.apply(this, arguments);
...
function cloneElementWithValidation(element, props, children) {
  const newElement = cloneElement$1.apply(this, arguments);
  for (let i = 2; i < arguments.length; i++) {
...
const React$1 = {
  ...
  createElement: __DEV__ ? createElementWithValidation : createElement$1,
  cloneElement: __DEV__ ? cloneElementWithValidation : cloneElement$1,
  createFactory: __DEV__ ? createFactoryWithValidation : createFactory$1,
...
if (__DEV__) {
  Object.assign(React$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, {
